        ...
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '标题' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.title" placeholder="标题" clearable></el-input>
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('news','查看') && contents.tableBtnIcon == 0" type="success" size="mini"
              ...
              <el-button v-if="isAuth('news','修改') && contents.tableBtnIcon == 0" type="primary" size="mini"
              ...
              <el-button v-if="isAuth('news','删除') && contents.tableBtnIcon == 0" type="danger" size="mini"

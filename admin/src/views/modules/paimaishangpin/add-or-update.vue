...
export default {
  ...
  methods: {
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                ...
                                                                                                                this.huodongzhuangtaiOptions = "竞拍中,已结束".split(',')
                            },
                                                                // 多级联动参数
                                                                                  info(id) {
      this.$http({
        url: `paimaishangpin/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `paimaishangpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.paimaishangpinCrossAddOrUpdateFlag = false;
                  this.parent.search();

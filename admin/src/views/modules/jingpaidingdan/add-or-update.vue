          ...
          <el-form-item class="input" label="商品类型" prop="shangpinleixing">
              <el-input v-model="ruleForm.shangpinleixing" 
                placeholder="商品类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成交价格" prop="chengjiaojiage">
          <el-input v-model="ruleForm.chengjiaojiage" 
              placeholder="成交价格" clearable  :readonly="ro.chengjiaojiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成交价格" prop="chengjiaojiage">
              <el-input v-model="ruleForm.chengjiaojiage" 
                placeholder="成交价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpinleixing = true;
            continue;
	            	            ...
	            	            if(o=='chengjiaojiage'){
            this.ruleForm.chengjiaojiage = obj[o];
	    this.ro.chengjiaojiage = true;
            continue;
          }
	            	            if(o=='faburiqi'){
    ...
    shangpinmingchengChange () {
      this.$http({
        url: `follow/paimaishangpin/shangpinmingcheng?columnValue=`+ this.ruleForm.shangpinmingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                if(data.data.shangpinleixing){
                this.ruleForm.shangpinleixing = data.data.shangpinleixing
              }
                ...
                this.ruleForm.shouji = data.data.shouji
                                                ...
                                                if(data.data.youxiang){
                this.ruleForm.youxiang = data.data.youxiang
              }
                                                if(data.data.dizhi){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jingpaidingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingpaidingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
